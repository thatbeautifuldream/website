      ...
      <Tabs defaultValue="coding-activity">
        <ScrollArea>
          <TabsList className="mb-3 w-auto gap-1 bg-transparent">
            <TabsTrigger
              className="flex-none whitespace-nowrap rounded-lg data-[state=active]:border data-[state=active]:bg-secondary data-[state=active]:text-secondary-foreground data-[state=active]:shadow-none"
