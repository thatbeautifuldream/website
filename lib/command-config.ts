...
const fuseCache = new WeakMap<TCommandAction[], Fuse<TCommandAction>>();
...
export const searchActions = (
  ...
  let fuse = fuseCache.get(actions);
  if (!fuse) {
    fuse = new Fuse(actions, fuseOptions);
    fuseCache.set(actions, fuse);
  }
