export const experience = [
  ...
  },
  {
    ...
    summary:
      "Layed UI foundations for a decentralized skill validation protocol, revolutionizing unbiased, transparent candidate evaluation for tech hiring.",
    highlights: [
      "Led Frontend MVP development for validators, candidates, and recruiters.",
      "Designed and implemented UI for a voting-based consensus algorithm to ensure fair and transparent skill validation across a network of 150+ validators.",
      "Built frontend for proctored assessment workflow with real-time streaming, cutting time-to-interview by 50%.",
