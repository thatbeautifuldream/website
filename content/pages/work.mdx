...
Prior to that, I was the Founding Product Engineer at [Proof-of-Skill Protocol](https://proofofskill.org), where I architected and launched a decentralized skill validation protocol revolutionizing unbiased, transparent candidate evaluation for tech hiring. I led MVP development, designed a voting-based consensus algorithm for 150+ validators, and built proctored assessment workflows that cut time-to-interview by 50%.
