...
import { getLocalizedPost, getLocalizedPosts } from '@/lib/i18n/content';
...
export const generateMetadata = async ({
    ...
    const page = getLocalizedPost(slug, locale);
